...
fun CaptureCameraScreen(
    ...
    Column(Modifier.fillMaxSize().background(Color.Black)) {
        Row(
            ...
            Text("CAPTURE • ${mode.uppercase()}", color = Color(0xFFFF2D2D))
        ...
        Row(
            ...
            OutlinedButton(onClick = { shots.lastOrNull()?.let { it.delete(); shots = shots.dropLast(1) } }, enabled = shots.isNotEmpty()) {
                Text("UNDO")
            }
        }
        ...
        Text(
            ...
            modifier = Modifier.padding(0.dp, 0.dp, 16.dp, 12.dp).align(androidx.compose.ui.Alignment.CenterHorizontally)
        )
    }
}
